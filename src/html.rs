...
fn get_repo_types() -> Vec<Repo> {
    let repos: Vec<Repo> = vec![
        ...
        Repo {
            display: "Open Privacy (Gitea)".to_string(),
        ...
        Repo {
            display: "Lightsout Games (Gitea)".to_string(),
            name: "lightsout".to_string(),
            url: "https://labs.lightsout.games/".to_string(),
            count: 0,
            percentage: "0".to_string(),
            crates: vec![],
        },
        Repo {
            display: "Redox OS (GitLab)".to_string(),
            name: "redox-os".to_string(),
            url: "https://gitlab.redox-os.org/".to_string(),
            count: 0,
            percentage: "0".to_string(),
            crates: vec![],
        },
        Repo {
            display: "Kernel (Cgit)".to_string(),
            name: "kernel".to_string(),
            url: "https://git.kernel.org/".to_string(),
            count: 0,
            percentage: "0".to_string(),
            crates: vec![],
        },
        Repo {
            display: "Open CoDE (GitLab)".to_string(),
            name: "opencode".to_string(),
            url: "https://gitlab.opencode.de/".to_string(),
            count: 0,
            percentage: "0".to_string(),
            crates: vec![],
        },
        Repo {
            display: "in2p3.fr (GitLab)".to_string(),
            name: "in2p3".to_string(),
            url: "https://gitlab.in2p3.fr/".to_string(),
            count: 0,
            percentage: "0".to_string(),
            crates: vec![],
        },
